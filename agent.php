    ...
    <div class="row"> 
        ...
        <!-- <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Staff</b></h2>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="full-row">
            <div class="container">
                ...
                <!-- FOR MORE PROJECTS visit: codeastro.com -->
                    <?php 
							$query=mysqli_query($con,"SELECT * FROM user WHERE utype='staff'");
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="hover-zoomer bg-white shadow-one mb-4">
                            ...
                            <div class="py-3 text-center">
                                <h5 class="text-secondary hover-text-primary"><a href="#"><?php echo $row['1'];?></a></h5>
                                <span>Amadis1 Investment | Team</span> </div>
                        </div>
                    </div>
